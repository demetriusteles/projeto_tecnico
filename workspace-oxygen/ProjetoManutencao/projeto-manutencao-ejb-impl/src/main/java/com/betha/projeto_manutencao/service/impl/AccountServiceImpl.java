...
public class AccountServiceImpl implements AccountService {
	...
	public UsuarioResponseDTO findByToken(final String nomeUsuario, final String token) throws AccountException {
		try {
			...
			return new UsuarioResponseDTO(usuario.getId(), usuario.getNome(), usuario.getUsuario(),
	...
	public UsuarioResponseDTO login(String authorization) throws AccountException {
        ...
        try {
			...
			geraToken(usuarios);
			return new UsuarioResponseDTO(usuarios.getId(), usuarios.getNome(), usuarios.getUsuario(),
